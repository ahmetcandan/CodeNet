...
internal class UpdateParameterGroupHandler(ParametersDbContext dbContext, ICodeNetHttpContext identityContext) : IRequestHandler<UpdateParameterGroupRequest, ResponseBase<ParameterGroupResult>>
{
