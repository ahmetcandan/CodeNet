...
internal class GetParameterGroupListHandler(ParametersDbContext dbContext, IIdentityContext identityContext) : IRequestHandler<GetParameterGroupListRequest, ResponseBase<List<ParameterGroupResult>>>
{
