...
internal class GetParameterGroupHandler(ParametersDbContext dbContext, IIdentityContext identityContext) : IRequestHandler<GetParameterGroupRequest, ResponseBase<ParameterGroupResult>>
{
