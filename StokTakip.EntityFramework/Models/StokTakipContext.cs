...
namespace StokTakip.EntityFramework.Models
{
    public partial class StokTakipContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data Source=.; Initial Catalog=StokTakip;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CampaignUsedHistory>(entity =>
            {
                entity.HasKey(e => new { e.CampaignId, e.SalesOrderId })
                    .HasName("pk_CampaignUsedHistory");

                entity.ToTable("CampaignUsedHistory");
                ...
                entity.HasOne(d => d.Campaign)
                    .WithMany(p => p.CampaignUsedHistories)
                    .HasForeignKey(d => d.CampaignId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
